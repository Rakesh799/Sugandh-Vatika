      ...
      <body className={`${poppins.className} antialiased`}>
        ...
        <Script id="gtm" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-PPPNQV6J');
          `}
        </Script>

        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-1L8S2FLZS8"
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-PPPNQV6J"
            height="0"
            width="0"
